...
const Skills = () => {
  return (
    <div id="skills" className="w-full my-16 p-2">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        <p className="text-3xl tracking-widest uppercase text-[#5651e5] py-4">
          What I Can Do
        </p>
        {/* <h2 className="py-4 text-2xl">What I Can Do</h2> */}
        <div className="grid md:grid=cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <img
                  src="https://res.cloudinary.com/dck687wut/image/upload/v1673387573/icons8-express-js-250_amnrou.png"
                  width="64"
                  height="64"
                  alt="/"
                />
